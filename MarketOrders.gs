  ...
  if(xml) {
    ...
    for(var i = 0; i < rows.length; i++) {
      order=[rows[i].getAttribute("orderID").getValue(),
                 ...
                 rows[i].getAttribute("volEntered").getValue(),
                 rows[i].getAttribute("volRemaining").getValue(),
                 rows[i].getAttribute("minVolume").getValue(),
                 rows[i].getAttribute("orderState").getValue(),
                 rows[i].getAttribute("typeID").getValue(),
                 rows[i].getAttribute("range").getValue(),
                 rows[i].getAttribute("accountKey").getValue(),
                 rows[i].getAttribute("duration").getValue(),
                 rows[i].getAttribute("escrow").getValue(),
                 rows[i].getAttribute("price").getValue(),
